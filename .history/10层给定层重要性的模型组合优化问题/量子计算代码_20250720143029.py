...
# --- 在初始化CIMOptimizer之前，设置检查点管理器 ---
# 1. 定义一个用于保存缓存和任务文件的目录名
save_path = "kaiwu_tasks_cache"

# 2. (可选但推荐) 确保这个目录存在
os.makedirs(save_path, exist_ok=True)

# 3. 将路径设置给 Kaiwu SDK 的 CheckpointManager
kw.common.CheckpointManager.save_dir = save_path
optimizer = kw.cim.CIMOptimizer(user_id="104451464537071618", sdk_code="wSHhidY0vaP4M3LTGBqx8kJWgrPD0f", task_name="model_combination_task")
